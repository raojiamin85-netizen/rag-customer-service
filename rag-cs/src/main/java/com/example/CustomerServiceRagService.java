...
public class CustomerServiceRagService {
    ...
    public CustomerServiceRagService() {
        ...
        this.agent = CustomerServiceAgent.create(contentRetriever, chatMemory);
    }
    ...
    public String answer(String question) {
        ...
        if (topMatches.isEmpty()) {
            topMatches = retrieveTopK(question, qaEntries, 3);
        }
        String prompt = buildPrompt(question, topMatches);
